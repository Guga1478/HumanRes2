<%-- 
    Document   : Rrhh
    Created on : Apr 12, 2021, 2:45:53 PM
    Author     : GUSATAVO
--%>
    ...
    <body>
        ...
        <div class="container" id="advanced-search-form">
            ...
            <form>
                ...
                <button type="submit" class="btn btn-info btn-md btn-responsive" id="Guardar" value="Guardar"> <span class="glyphicon glyphicon-search"></span> Guardar</button>
            </form>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td class="success"><%= rs.getString("firstName")%></td>
                        <td class="active"><%= rs.getString("lastName")%></td>
                        <td class="success"><%= rs.getString("email")%></td>
                        <td class="active"><%= rs.getString("phoneNumber")%></td>
                        ...
                        <td class="success"><%= rs.getInt("managerId")%></td>
            ...
            <form>
                ...
                <div class="form-group">
                    <label for="minSal">Min Sal:</label>
                    <input type="number" class="form-control" placeholder="Min Sal" name="minSal" id="minSal">
                </div>
                <div class="form-group">
                    <label for="maxSal">Max Sal:</label>
                    <input type="number" class="form-control" placeholder="Max Sal" name="maxSal" id="maxSal">
                </div>
                <div class="form-group">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="active"><%= rs.getInt("minSalary")%></td>
                            <td class="success"><%= rs.getInt("maxSalary")%></td>
                            <td class="active"><%= rs.getInt("controlNumber")%></td>
                        </tr>
                        <%
                            }
                        %>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="success"><%= rs.getInt("locationId")%></td>
                        </tr>
                        <%
                            }
                        %>
               ...
               <!-- <div class="form-group">
                    ...
                    <input type="text"  placeholder="Buscar Department" name="buscarDepartments" id="buscarDepartments">
                </div>
                <div class="clearfix"></div>
...
-->
              <form>
                   ...
                   <button type="submit" class="btn btn-info btn-md btn-responsive" name="buscarDepartments" id="buscarDepartments" value="Buscar"> <span class="glyphicon glyphicon-search"></span> Buscar Department</button>
                </form>
